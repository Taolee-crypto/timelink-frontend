    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black text-white p-6 md:p-12">
      ...
      <header className="max-w-7xl mx-auto flex justify-between items-center mb-16">
        ...
        <div className="flex items-center gap-6">
          <div className="text-lg">
            Live: <span className="text-amber-400 font-bold">{2847 + boostCount}</span>
          </div>
      ...
      <div className="text-center mb-20">
        ...
        <p className="text-xl md:text-2xl text-slate-300 mb-10">
          네가 듣는 1초가 누군가의 자산이 되는 곳
        </p>
        <button 
          onClick={() => setBoostCount(boostCount + 100)}
          className="px-10 py-5 bg-gradient-to-r from-amber-600 to-amber-500 text-black text-2xl font-bold rounded-2xl hover:brightness-110 transition shadow-2xl shadow-amber-900/50"
        >
          Boost +100 TL ({boostCount})
        </button>
      </div>
